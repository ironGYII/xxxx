...
from app.lib.config import contract_address, helper_abi, public_to_private_keys
...
def mount_client():
    ...
    return jsonify(dict(code=200, data=dict(contract_address=contract_address, abi=helper_abi, public_to_private_keys=public_to_private_keys)))